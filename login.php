...
<body class="min-h-screen flex items-center justify-center p-6">
    ...
    <form action="./src/auth/login.php" method="POST" class="bg-black backdrop-blur-sm p-8 rounded-xl shadow-2xl w-full max-w-md space-y-6">
        <h1 class="text-3xl font-bold text-white text-center mb-6">Login Here</h1>
        ...
        <div>
            <input type="submit" value="Login" 
                   class="w-full px-4 py-3 bg-white text-black font-semibold rounded-lg hover:bg-gray-200 focus:outline-none focus:ring-2 focus:ring-yellow-500 cursor-pointer transition duration-300">
        </div>

        <div class="text-center mt-4">
            <p class="text-sm text-gray-400">If you Don't have an account? Please Sign up <a href="./register.php" class="text-blue-400 hover:text-blue-500">Sign up</a></p>
        </div>
    </form>
